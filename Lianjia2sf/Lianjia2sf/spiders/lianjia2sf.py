...
class Lianjia2sfSpider(scrapy.Spider):
    ...
    def parse_gethouseUrl(self, response):
        ...
        # 获取下一页
        # pagedata = json.loads(response.xpath('//div[@class="page-box house-lst-page-box"]/@page-data').extract()[0])
    ...
    def parse_gethouseInfo(self, response):
        ...
        yield item
        # print(response.xpath('/html/body/div[5]/div[2]/div[4]/div[1]/a[1]/text()').extract()[0]
